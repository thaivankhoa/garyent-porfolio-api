class TransactionQuery < BaseQuery
  ...
  def apply_filters(scoped)
    ...
    scoped = filter_by_portfolio_coin(scoped)
    scoped
  end
  ...
  def filter_by_type(scoped)
    return scoped unless filter_params[:transaction_type].present?
  ...
  def filter_by_portfolio(scoped)
    return scoped unless filter_params[:portfolio_id].present?
  ...
  def filter_by_portfolio_coin(scoped)
    return scoped unless filter_params[:portfolio_coin_id].present?
